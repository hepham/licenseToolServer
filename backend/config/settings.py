"""
Django settings for License Server project.
"""
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'license_server'),
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API for software license management - activation, validation, and administration',
    'VERSION': '1.0.0',
    'SERVE_INCLUDE_SCHEMA': False,
    'COMPONENT_SPLIT_REQUEST': True,
    'TAGS': [
        {'name': 'Authentication', 'description': 'JWT token management'},
        {'name': 'License Activation', 'description': 'License activation and validation for end users'},
        {'name': 'Admin', 'description': 'License and device management for administrators'},
    ],
}
